        ...
        .insert("after", "save[-1]", [
          {
            _key: uuidv4(),
            userId: user.email,
            //make _ref a valid number possibly user.sub?
          ...
          >
            ...
            <div className=" flex justify-between items-center gap-2 w-full ">
              ...
              {postedBy?._id === user.sub && (
                <button
                  type="button"
                  className=" bg-white p-2 opacity-70 hover:opacity-100 text-dark font-bold  text-base rounded-3xl hover: shadow-sm outline-none "
                  onClick={(e) => {
                    e.stopPropagation();
                    deletePin(_id);
                  }}
